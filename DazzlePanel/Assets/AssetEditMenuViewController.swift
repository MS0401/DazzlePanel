//
//  AssetEditMenuViewController.swift
//  DazzlePanel
//
...
class AssetEditMenuViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func SortedByGroup(_ sender: UIButton) {
    ...
    @IBAction func Follow1Button_Touched(_ sender: UIButton) {
        
        if self == self.navigationController?.viewControllers[0] {
            self.dismiss(animated: true, completion: nil) //doesn't deinit
        }else{
            self.navigationController?.popViewController(animated: true) //deinits correctly
        }
    }
    @IBAction func Follow2Button_Touched(_ sender: UIButton) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "assets", for: indexPath) as! AssetsViewCell1
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let assetsScreen = self.storyboard?.instantiateViewController(withIdentifier: "assetsScreen") as! AssetsScreenViewController
        self.navigationController?.pushViewController(assetsScreen, animated: true)
